...
public class CSVsReceiverController {
    ...
    public CSVsReceiverController(BikeReportService bikeReportService) {
        this.bikeReportService = bikeReportService;
    }

    @PostMapping("/receive-and-extract")
    public ResponseEntity<String> receiveAndExtract(@RequestParam("file") MultipartFile file, @RequestParam("report") BikeReport bikeReport) {
        bikeReportService.csvConverter(file, bikeReport);
        return ResponseEntity.ok().body("CSV received");
    }
